...
Langtrace supports multiple authentication methods. Make sure to configure the necessary environment variables for your chosen authentication method(s) in the `.env` file. For detailed instructions, refer to our [Authentication Options](/hosting/auth) guide.
...
After setting up Langtrace using Docker Compose, ensure that you've properly configured your chosen authentication method(s) and created the necessary user accounts. Refer to the [Authentication Options](/hosting/auth) guide for detailed instructions on setting up and managing authentication.
