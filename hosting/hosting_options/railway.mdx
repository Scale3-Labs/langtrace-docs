...
- For additional authentication methods (e.g., Google OAuth, Azure AD), you can add the necessary environment variables here as well. Refer to our [Authentication Options](/hosting/auth) guide for detailed instructions on configuring other authentication methods.
