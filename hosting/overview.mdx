...
Langtrace supports multiple authentication methods, including Admin Password, Google OAuth, and Azure AD OAuth. For detailed instructions on configuring authentication for your self-hosted setup, refer to our [Authentication Options](/hosting/auth) guide.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Kubernetes"
    icon="dharmachakra"
    href="/hosting/hosting_options/kubernetes"
  >
