---
title: How to Trace user id and feedback using Langtrace AI
---

When you are using Langtrace AI, you can trace user id and feedback using the `with_additional_attributes` function.
