...
When you are using Langtrace, you can pass both user id and user feedback using the `Langtrace.withLangTraceRootSpan` function.
...
Langtrace.init({
  ...
  api_key: "f091f39fc6a9b0eab23a48b39ab4dab8eaef5fcf78b0bb5950fb42c0e1d75f7a"
});
