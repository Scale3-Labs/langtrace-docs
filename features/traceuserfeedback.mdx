...
<CodeGroup>
  ...
  ```python Python
  from langtrace_python_sdk import send_user_feedback
  send_user_feedback(spanId, traceId, userScore, userId)
  ```
</CodeGroup>
## Examples
