...
<Note>
Currently langtrace doesn't support `inspect-ai` versions greater than `0.3.14`. Versions higher than `0.3.14` are causing [this](https://github.com/UKGovernmentBEIS/inspect_ai/issues/135) issue.
</Note>
