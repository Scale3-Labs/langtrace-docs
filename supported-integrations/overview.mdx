...
| [EmbedChain](/supported-integrations/llm-frameworks/embedchain)         | Framework       |    &#x2718;    |  &#x2714;  |    [Link](https://github.com/Scale3-Labs/langtrace-python-sdk/blob/main/src/examples/embedchain_example/simple.py)     |
...
| [Mistral AI](/supported-integrations/llm-tools/mistral-ai)      | LLM |    &#x2714;    |  &#x2714;  |     [Link](https://github.com/Scale3-Labs/langtrace-python-sdk/blob/main/src/examples/mistral_example/complete.py)      |
