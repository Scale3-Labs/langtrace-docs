...
Using Langtrace to monitor your OPEN AI'S GPT 3.5 MODEL is quick and easy. Follow these steps:

## Setup

1. Install the Langtrace and OpenAI SDKs.

*Note: You'll need API keys from Langtrace and OPENAI'S GPT 3.5 MODEL. Sign up for [Langtrace](https://langtrace.ai) and/or [OpenAI](https://openai.com/) if you haven't done so already.*
