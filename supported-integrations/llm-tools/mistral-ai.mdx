...
Want to see more supported methods? Checkout the sample code in the [Langtrace Mistral Python Example](https://github.com/Scale3-Labs/langtrace-python-sdk/blob/main/src/examples/mistral_example/complete.py) repository.